...
<div class="container">
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h2 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','roofing-services'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h2>
		<?php else : ?>
			<h3 class="page-title"><?php esc_html_e( 'Nothing Found', 'roofing-services' ); ?></h3>
		<?php endif; ?>
	</header>

	<div class="content-area">
		<main id="skip-content" class="site-main" role="main">
			<?php $roofing_services_layout_option = get_theme_mod( 'roofing_services_archive_page_sidebar', 'Right Sidebar' );
			        ...
			        <div class="content_area col-lg-8 col-md-8">
				    	<section id="post_section">
							...
							if ( have_posts() ) :
								...
								<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'roofing-services' ); ?></p>
								<?php
									get_search_form();
