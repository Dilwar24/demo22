...
class Roofing_Services_Loader {
	 ...
	 * @return void
	 */
	public function roofing_services_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function roofing_services_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function roofing_services_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function roofing_services_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->roofing_services_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function roofing_services_load( $class ) {
